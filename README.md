...
:-------------------------|-------------------------|-------------------------|-------------------------
[BlogMotion](https://www.blogmotions.de/)| React, TypeScript, Material UI, TailwindCSS, Redux, Redux Toolkit, Toastify, React-Router, Axios (Instance), Formik & Yup, Redux Persist, Node.js, Express.js, JWT, Stripe , Cors, Swagger, Redoc |![Blog Motion](https://github.com/user-attachments/assets/35436483-5e24-4b53-a91e-c10cb280d7b7)|[Source Code](https://github.com/ucangun/Blog_Motion)
